...
import { DistributeRewardComponent } from './distribute-reward/distribute-reward.component';
...
export class TicketsComponent implements OnInit, OnDestroy, Disposable {
    ...
    distributeReward(item: SavedTicket) {

        const modal = this.modalService.open(DistributeRewardComponent, { backdrop: 'static', keyboard: false });
        (<DistributeRewardComponent>modal.componentInstance).walletName = this.walletName;
        (<DistributeRewardComponent>modal.componentInstance).selectedSenderAddress = this.selectedAddress;
        (<DistributeRewardComponent>modal.componentInstance).balance = this.balance;
        (<DistributeRewardComponent>modal.componentInstance).coinUnit = this.coinUnit;
        (<DistributeRewardComponent>modal.componentInstance).ticket = item;
        modal.result.then(value => {
